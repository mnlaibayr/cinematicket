...
public class cinematicket extends JFrame implements ActionListener
{
    
      JTextField seat, totalcost;
      Choice type, block, time, kino ; 
      JLabel kinolbl, typelbl,blocklbl, rblbl, timelbl, lblbl, mblbl, inputseatlbl, totallbl, title;
      JButton submitbut, showbut, paybut;
      String selectedtime, selectedseat,  total, selectedblock, tickettype;
      ...
      public cinematicket()
      {
       ...
       setLocation(300,300);
       setResizable(false);
       setTitle("kino ticket");
       setLayout(new FlowLayout());
       ImageIcon imgtitle = new ImageIcon ("C:\\Users\\user\\Desktop\\books webstie\\image\\");
       title = new JLabel(imgtitle);
       
       
       kinolbl = new JLabel("kino");
       kinolbl.setFont(new Font("Verdana", Font.BOLD, 22));
       kino= new Choice();
       kino.add("Eternals");
       kino.add("Spiderman");
       kino.add("Venom");
       ...
       typelbl = new JLabel("Тасалбар");
       typelbl.setFont(new Font("Verdana", Font.BOLD, 22));
       type= new Choice();
       type.add("Том хүн");
       type.add("Оюутан");
       type.add("Хүүхэд");
       blocklbl =new JLabel("Эгнээ");
       blocklbl.setFont(new Font("Verdana", Font.BOLD, 22));
       block = new Choice();
       block.add("Урд эгнээ");
       block.add("Дунд эгнээ");
       block.add("Хойд эгнээ");
       timelbl = new JLabel("Цаг ");
       ...
       ImageIcon lbimg = new ImageIcon("C:\\Users\\user\\Documents\\NetBeansProjects\\cinematicket\\img\\");
       lblbl = new JLabel (lbimg);
       ImageIcon mbimg = new ImageIcon("");
       mblbl = new JLabel  (mbimg);
       ImageIcon rbimg = new ImageIcon("C:\\Users\\user\\Documents\\NetBeansProjects\\cinematicket\\img\\");
       rblbl = new JLabel (rbimg);
       inputseatlbl = new JLabel ("Суудлын дугаар");
       inputseatlbl.setFont(new Font ("Verdana", Font.BOLD, 22));
       seat = new JTextField(2);
       seat.setFont(new Font ("Verdana", Font.BOLD,22));
       ...
       for (int i = 0; i < leftside5.length; i++)
       {
           for (int j = 0;  j < 4; j++)
           {
               ...
               xleft +=50;//moving the next sead along the x position by 50
               totalleftside5 ++;// adding one the total for the next seat
       ...
       for (int i = 0; i < leftside9.length; i++)
       {
           for (int j = 0;  j< 4; j++)
           {
               ...
               xleft +=50;//moving the next sead along the x position by 50
               totalleftside9++;// adding one the total for the next seat
               
           }
           xleft =50; //movie back to the left for the next row
       ...
       for (int i = 0; i <rightside9.length; i++)
       {
         ...
         getContentPane() .add(kinolbl);
         getContentPane() .add(kino);
         ...
         Color mycolor = new Color(0, 191, 255);
    ...
    cinematicket(Socket client, Socket client2) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    cinematicket(Socket client) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
                      ...
                      if (selectseat == 11)
                       ...
                       if (selectseat == 12)
                        ...
                        if (selectedtime =="13:00")
                        {
                            timechoice = 1;
                            repaint();
                            if (selectedblock == "Урд эгнээ")
                            {
                                int iftaken = leftside1[convertedseat1][convertedseat2].isTaken();
                                if (iftaken == 1)
                                {
                                    JOptionPane.showMessageDialog(null, "Суудал захиалагдсан");
                                }
                                else if (iftaken == 0)
                                {
                                    ...
                                    totalcost.setText("MNT"+ Integer.toString(totalprice));
                                    totaltickets += 1;
                                    seat.setText("");
                                }
                            
                            }
                            if (selectedblock == "Дунд эгнээ")
                            {
                           ...
                           if (selectedtime =="17:00")
                        {
                                 ...
                                 if (selectedblock == "Хойд эгнээ")
                            {
                                ...
                                if (iftaken == 1)
                                { 
                                    JOptionPane.showMessageDialog(null, "Суудал захиалдсан");
                                }
                                else if (iftaken ==0)
                                {
...
//          { 
//              private Socket socket = null;
//              private cinematicketSocket cinematicket = null;
//              private DataInputStream in = null;
//              
//              
//              public Cinematicket(int port )
//              {
//                 
//              }
//                 try
...
//              
          ...
          if (ev.getSource() == paybut){
            ...
            JOptionPane.showMessageDialog(null, "Хүсэлт амжилттай");
    ...
    Logger.getLogger(cinematicket.class.getname()).Log(Level.SEVERE, null, ex );
